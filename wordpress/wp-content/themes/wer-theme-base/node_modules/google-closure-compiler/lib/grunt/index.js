...
module.exports = (grunt, pluginOptions) => {
  ...
  const VinylStream = require('google-closure-compiler/lib/grunt/vinyl-stream');
  const Transform = require('stream').Transform;
  const gulpCompilerOptions = {};
  const {getFirstSupportedPlatform} = require('google-closure-compiler/lib/utils');
  ...
  function compilationPromise(files, options, pluginOpts) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      const gulpCompiler = require('google-closure-compiler/lib/gulp')(args);
