...
module.exports = function(initOptions) {
  const filesToJson = require('google-closure-compiler/lib/gulp/concat-to-json');
  const jsonToVinyl = require('google-closure-compiler/lib/gulp/json-to-vinyl');
  ...
  function getCompiler(platform) {
    return require('google-closure-compiler/lib/node/closure-compiler');
  }
